...
internal data class MovementsStrings(
    ...
    val quickScanAction: String,
    val quickManualAction: String,
    val quickActionsTitle: String,
    val quickActionsSubtitle: String,
    val currentStockLabel: String,
    val minimumStockLabel: String,
    val scanResolvingTitle: String,
    val scanResolvingSubtitle: String,
    val invalidLabelTitle: String,
    val invalidLabelDescription: String,
    val notFoundTitle: String,
    val notFoundDescription: String,
    val ambiguousTitle: String,
    val ambiguousDescription: String,
...
internal fun runtimeComponentVaultStrings(): ComponentVaultStrings {
    return ComponentVaultStrings(
        ...
        movements = MovementsStrings(
            ...
            quickScanAction = stringResource(R.string.movements_action_scan_label),
            quickManualAction = stringResource(R.string.movements_action_manual_record),
            quickActionsTitle = stringResource(R.string.movements_quick_actions_title),
            quickActionsSubtitle = stringResource(R.string.movements_quick_actions_subtitle),
            currentStockLabel = stringResource(R.string.movements_current_stock_label),
            minimumStockLabel = stringResource(R.string.movements_minimum_stock_label),
            scanResolvingTitle = stringResource(R.string.movements_scan_resolving_title),
            scanResolvingSubtitle = stringResource(R.string.movements_scan_resolving_subtitle),
            invalidLabelTitle = stringResource(R.string.movements_invalid_label_title),
            invalidLabelDescription = stringResource(R.string.movements_invalid_label_description),
            notFoundTitle = stringResource(R.string.movements_not_found_title),
            notFoundDescription = stringResource(R.string.movements_not_found_description),
            ambiguousTitle = stringResource(R.string.movements_ambiguous_title),
            ambiguousDescription = stringResource(R.string.movements_ambiguous_description),
            scannerPermissionTitle = stringResource(R.string.movements_scanner_permission_title),
            scannerPermissionDescription = stringResource(R.string.movements_scanner_permission_description),
            scannerPermissionDeniedTitle = stringResource(R.string.movements_scanner_permission_denied_title),
            scannerPermissionDeniedDescription = stringResource(R.string.movements_scanner_permission_denied_description),
            scannerStarting = stringResource(R.string.movements_scanner_starting),
