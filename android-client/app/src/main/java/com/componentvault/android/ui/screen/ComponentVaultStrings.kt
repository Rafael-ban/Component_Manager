...
internal fun runtimeComponentVaultStrings(): ComponentVaultStrings {
    return ComponentVaultStrings(
        ...
        settings = SettingsStrings(
            ...
            autoSync = stringResource(R.string.setting_auto_sync),
            ...
            formTitle = stringResource(R.string.settings_form_title),
            formSubtitle = stringResource(R.string.settings_form_subtitle),
            serverUrlPlaceholder = stringResource(R.string.server_url_placeholder),
            autoSyncDescription = stringResource(R.string.auto_sync_description),
        ),
        forms = FormsStrings(
