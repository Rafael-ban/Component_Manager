...
The project is distributed as an unpackaged, self-contained x64 ZIP. Extract
the complete archive and run `ComponentVault.WinUI.exe`; no test certificate or
administrator installation step is required.
